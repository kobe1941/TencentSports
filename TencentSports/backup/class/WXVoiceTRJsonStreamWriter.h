...
@class NSMutableArray, NSString, WXVoiceTRJsonStreamWriterState;
@protocol WXVoiceTRJsonStreamWriterDelegate;

@interface WXVoiceTRJsonStreamWriter : NSObject
{
    NSString *error;
    NSMutableArray *stateStack;
    WXVoiceTRJsonStreamWriterState *state;
    id <WXVoiceTRJsonStreamWriterDelegate> delegate;
...
+ (void)initialize;
@property id <WXVoiceTRJsonStreamWriterDelegate> delegate; // @synthesize delegate;
...
@property(nonatomic) __weak WXVoiceTRJsonStreamWriterState *state; // @synthesize state;
