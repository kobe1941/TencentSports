...
#import "ODKAFURLConnectionOperation.h"

@class NSError, NSHTTPURLResponse, NSRecursiveLock, ODKAFHTTPResponseSerializer;
@protocol ODKAFURLResponseSerialization;

@interface ODKAFHTTPRequestOperation : ODKAFURLConnectionOperation
{
