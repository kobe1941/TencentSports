...
@class NSOperationQueue, NSURL, NSURLCredential, ODKAFHTTPRequestSerializer, ODKAFHTTPResponseSerializer, ODKAFNetworkReachabilityManager, ODKAFSecurityPolicy;
@protocol ODKAFURLRequestSerialization, ODKAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface ODKAFHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    _Bool _shouldUseCredentialStorage;
    NSURL *_baseURL;
    ODKAFHTTPRequestSerializer<ODKAFURLRequestSerialization> *_requestSerializer;
    ODKAFHTTPResponseSerializer<ODKAFURLResponseSerialization> *_responseSerializer;
    NSOperationQueue *_operationQueue;
    NSURLCredential *_credential;
    ODKAFSecurityPolicy *_securityPolicy;
    ODKAFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) ODKAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) ODKAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
...
@property(retain, nonatomic) ODKAFHTTPResponseSerializer<ODKAFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) ODKAFHTTPRequestSerializer<ODKAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
