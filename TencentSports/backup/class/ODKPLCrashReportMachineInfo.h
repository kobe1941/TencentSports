...
@class NSString, ODKPLCrashReportProcessorInfo;

@interface ODKPLCrashReportMachineInfo : NSObject
{
    NSString *_modelName;
    ODKPLCrashReportProcessorInfo *_processorInfo;
...
@property(readonly, nonatomic) ODKPLCrashReportProcessorInfo *processorInfo; // @synthesize processorInfo=_processorInfo;
