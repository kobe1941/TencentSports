...
@class HVMPRightSectionHeaderView, KKMediaRootViewController, KKVideoInfo, NSArray, NSDate, NSMutableArray, NSString, QLASIHTTPRequest, QLActivityLabel, QLCoverRelatedModel, QLFooterDragRefreshView, QLHeaderDragRefreshView, QLMainMovieControlView, QLQLErrorView, UITableView;
...
@property(retain, nonatomic) QLQLErrorView *errorView; // @synthesize errorView;
