...
@class QSComWebRoundedRectImageView, QSMyMainEntranceItem, QSRedPointView, UILabel;

__attribute__((visibility("hidden")))
@interface QSMyMainItemType2Cell : UICollectionViewCell
{
    QSMyMainEntranceItem *_entranceItem;
    UILabel *_nameLabel;
    UILabel *_subNameLabel;
    QSComWebRoundedRectImageView *_iconView;
...
@property(retain, nonatomic) QSComWebRoundedRectImageView *iconView; // @synthesize iconView=_iconView;
