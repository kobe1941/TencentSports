...
@class NSMutableData, NSProgress, NSString, NSURL, ODKAFURLSessionManager;

@interface ODKAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    ODKAFURLSessionManager *_manager;
...
@property(nonatomic) __weak ODKAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
