...
@interface QSPlayerRanklistBasketballTabDataItem : QSModel
{
    NSString *_serial;
    NSString *_name;
    NSString *_playerId;
...
@property(retain, nonatomic) NSString *assistsPG; // @synthesize assistsPG=_assistsPG;
@property(retain, nonatomic) NSString *reboundsPG; // @synthesize reboundsPG=_reboundsPG;
@property(retain, nonatomic) NSString *pointPG; // @synthesize pointPG=_pointPG;
