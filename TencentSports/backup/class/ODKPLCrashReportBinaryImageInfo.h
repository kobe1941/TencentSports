...
@interface ODKPLCrashReportBinaryImageInfo : NSObject
{
...
@property(readonly, nonatomic) ODKPLCrashReportProcessorInfo *codeType; // @synthesize codeType=_processorInfo;
- (void)dealloc;
