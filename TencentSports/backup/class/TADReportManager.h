...
- (void)reportiABItem:(id)arg1 actionType:(long long)arg2;
- (id)p_findStreamAdByOid:(id)arg1;
- (void)p_removeAd:(id)arg1;
- (void)p_removeUnlikedAd:(id)arg1;
- (void)p_checkPvLimitWithInfo:(id)arg1;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;
- (void)reportPreloadItemsForType:(long long)arg1;
- (void)reportClickItem:(id)arg1 actionType:(long long)arg2;
- (void)reportItem:(id)arg1 forTADActionType:(long long)arg2;
- (void)reportItems:(id)arg1 forTADActionType:(long long)arg2;
- (void)p_reportItem:(id)arg1 forTADActionType:(long long)arg2;
- (void)dealloc;
- (void)reset;
