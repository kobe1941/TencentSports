...
@class ODKPLCrashReportSymbolInfo;

@interface ODKPLCrashReportStackFrameInfo : NSObject
{
    unsigned long long _instructionPointer;
    ODKPLCrashReportSymbolInfo *_symbolInfo;
}

@property(readonly, nonatomic) ODKPLCrashReportSymbolInfo *symbolInfo; // @synthesize symbolInfo=_symbolInfo;
