...
@class NSMutableArray, NSNumber, NSString, QSCommunityMainNewActData, QSTableView;

__attribute__((visibility("hidden")))
@interface QSCommunityMainNewActViewController : QSViewController <UITableViewDataSource, QSTableViewDelegate, QSBaseDataDelegate, QSStatedDataDelegate, QSContainerViewControllerContainedVCProtocol>
{
    QSTableView *_tableView;
    NSMutableArray *_topics;
    NSNumber *_savedContentOffsetY;
    QSCommunityMainNewActData *_mainNewActData;
}

@property(retain, nonatomic) QSCommunityMainNewActData *mainNewActData; // @synthesize mainNewActData=_mainNewActData;
