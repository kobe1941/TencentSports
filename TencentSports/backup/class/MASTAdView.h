...
@class MASTAdBrowser, MASTMRAIDBridge, MASTMRAIDExpandProperties, MASTMoceanAdDescriptor, MASTModalViewController, MPVolumeView, NSMutableData, NSMutableDictionary, NSString, NSTimer, NSURLConnection, NSURLRequest, UIButton, UIControl, UIImageView, UILabel, UITapGestureRecognizer;
@protocol MASTAdViewDelegate;

@interface MASTAdView : UIView <UIGestureRecognizerDelegate, UIWebViewDelegate, MASTMRAIDBridgeDelegate, MASTAdBrowserDelegate, MASTModalViewControllerDelegate, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>
{
