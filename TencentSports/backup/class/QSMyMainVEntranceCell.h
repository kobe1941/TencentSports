...
@class NSArray, NSString, QSMyMainData, UICollectionView;
@protocol QSMyMainViewPopWebViewDelegate;

__attribute__((visibility("hidden")))
@interface QSMyMainVEntranceCell : UITableViewCell <UICollectionViewDataSource, UICollectionViewDelegate, QSMyProfileTableCellBossProtocol>
{
