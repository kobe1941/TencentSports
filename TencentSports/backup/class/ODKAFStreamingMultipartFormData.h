...
#import "ODKAFMultipartFormData-Protocol.h"

@class NSMutableURLRequest, NSString, ODKAFMultipartBodyStream;

@interface ODKAFStreamingMultipartFormData : NSObject <ODKAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    ODKAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) ODKAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
