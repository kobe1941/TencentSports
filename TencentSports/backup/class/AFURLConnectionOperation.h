...
@interface AFURLConnectionOperation : QSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSCoding, NSCopying>
{
    _Bool _cancelled;
...
- (void)setDownloadProgressBlockEx:(CDUnknownBlockType)arg1;
- (void)setUploadProgressBlockEx:(CDUnknownBlockType)arg1;
