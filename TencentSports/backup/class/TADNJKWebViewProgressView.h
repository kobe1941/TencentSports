...
@class CAGradientLayer, TADNJKWebViewProgress;

@interface TADNJKWebViewProgressView : UIView
{
    float _progress;
    ...
    TADNJKWebViewProgress *_webViewProgress;
    CAGradientLayer *_rainbowlayer;
}

@property(retain, nonatomic) CAGradientLayer *rainbowlayer; // @synthesize rainbowlayer=_rainbowlayer;
@property(nonatomic) __weak TADNJKWebViewProgress *webViewProgress; // @synthesize webViewProgress=_webViewProgress;
