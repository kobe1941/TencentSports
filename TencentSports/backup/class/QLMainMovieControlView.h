...
@interface QLMainMovieControlView : QLMovieBaseControlView <QLMomentInputViewDelegate, QLBanabaCommentButtonDelegate, UIGestureRecognizerDelegate, QLActionMenuDelegate, QLMPClarityListViewDelegate, QLMPComplexPanelViewDelegate, QLLiveTitleUpdateDelegate, QLSeeBackDelegate>
{
