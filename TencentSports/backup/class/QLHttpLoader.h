...
#import "QLHttpProgressDelegate-Protocol.h"
#import "QLHttpRequestDelegate-Protocol.h"

@class NSData, NSError, NSMutableDictionary, NSString, NSURLResponse, QLHttpRequest;

@interface QLHttpLoader : NSObject <QLHttpRequestDelegate, QLHttpProgressDelegate>
{
    QLHttpRequest *_request;
    NSString *_url;
