...
@class NSArray, NSDictionary, NSString, TADMediaConnection, TADMediaViewController, TADPlayerNetworkErrorView, TADPlayerView, UIButton;
...
@property(nonatomic) _Bool isViewRotation; // @synthesize isViewRotation=_isViewRotation;
...
- (void).cxx_destruct;
- (void)noticeRichViewPageWillAppear;
- (void)noticeRichViewPageWillDisappear;
- (id)landingPresentVC;
