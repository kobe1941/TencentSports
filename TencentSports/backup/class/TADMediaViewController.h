...
@class MASTAdView, NSArray, NSDate, NSMutableArray, NSString, NSTimer, PassthroughView, TADAdSelectorView, TADAudioRecorder, TADInsetsLabel, TADLandingControlManager, TADLandingViewController, TADMediaItem, TADMediaLog, TADQLMediaPing, TADQQNewsTrueViewTipsView, TADRemainView, TADReportDP3, TADReportMediaItemList, TADReportSingleMediaItem, TADSafariHelper, TADTouchableView, TADUserInfo, TADYoutubeSytleRemainView, UIButton, UINavigationController, UIView;
@protocol TADMediaViewControllerDelegate;

@interface TADMediaViewController : UIViewController <TADRemainViewDelegate, TADLandingViewControllerDelegate, MASTAdViewDelegate, TADAudioRecorderDelegate, TADYoutubeSytleRemainViewDelegate, TADQQNewsTrueViewTipsViewDelegate, TADSafariHelperDelegate>
{
...
- (_Bool)isMuted;
- (void)notifyVolumnWillTurnOn:(_Bool)arg1;
...
- (void)noticeRichViewisDisappearing:(_Bool)arg1;
