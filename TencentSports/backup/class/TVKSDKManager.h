...
@class NSArray, NSData, NSDictionary, NSMutableDictionary, NSString, UIViewController;
...
@property(retain, nonatomic) NSString *auth_from; // @synthesize auth_from=_auth_from;
