...
@interface KKMediaRootViewController : TVKMediaViewController <UITableViewDelegate, UITableViewDataSource, KKScreenLockDelegate, QLBanabaViewControllerDataSource, QLInteractiveVoteOperationDelegate, KKMediaPlayerEventProtocol, QLPlayerCacheJusterDelegate, P_QLMPlayerControlDelegate, KKMediaPlayPrepareDelegate, KKMediaPlayerDelegate, KKAdsDelegate, QLShareDataSource, NetworkCheckerDelegate, KKbackAdvertismentAddedProtocol, KKMediaControllPlayerProtocol>
{
    ...
    int _vip_type;
    int _vrType;
    NSMutableDictionary *_tryWatchDic;
    ...
    QLSeeBackBusiness *_seeBackBusiness;
...
@property(nonatomic) _Bool isEnableDistoration; // @synthesize isEnableDistoration=_isEnableDistoration;
...
@property(retain, nonatomic) QLSeeBackBusiness *seeBackBusiness; // @synthesize seeBackBusiness=_seeBackBusiness;
...
@property(nonatomic) id <QSSportsTVLiveDelegate> sportsTVLiveDelegate; // @synthesize sportsTVLiveDelegate=_sportsTVLiveDelegate;
@property(retain, nonatomic) NSMutableDictionary *tryWatchDic; // @synthesize tryWatchDic=_tryWatchDic;
...
- (id)currentUserSelectVideoFormat;
- (_Bool)isWifiOrKingCard;
...
- (void)roateVRcamera:(float)arg1 andY:(float)arg2;
...
- (_Bool)readyPlayItemInCurrentCover;
- (_Bool)playerWillPlayVarietyVideoMainItem;
