...
#import "ODKAFURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class NSURL, ODKAFHTTPRequestSerializer, ODKAFHTTPResponseSerializer;
@protocol ODKAFURLRequestSerialization, ODKAFURLResponseSerialization;

@interface ODKAFHTTPSessionManager : ODKAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) ODKAFHTTPResponseSerializer<ODKAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
