...
#import "TADScanQRCodeViewControllerDelegate-Protocol.h"
...
@class NSString, TADBlockedLandingView, TADLandingViewBackgroundView, TADNJKWebViewProgress, TADNJKWebViewProgressView, TADNetworkView, TADShareItem, TADStoreViewController, TADTapToReloadView, UIBarButtonItem, UILabel, UIToolbar, UIView, UIWebView;
