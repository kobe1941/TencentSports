...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, ODKAFNetworkReachabilityManager, ODKAFSecurityPolicy;
@protocol ODKAFURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface ODKAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <ODKAFURLResponseSerialization> _responseSerializer;
...
@property(retain, nonatomic) id <ODKAFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
