...
@class NSData, NSDictionary, NSError, NSInputStream, NSObject, NSOutputStream, NSRecursiveLock, NSSet, NSString, NSURLConnection, NSURLCredential, NSURLRequest, NSURLResponse, ODKAFSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue;

@interface ODKAFURLConnectionOperation : NSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSSecureCoding, NSCopying>
{
