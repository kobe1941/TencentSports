...
@class NSString, QSMyReplyTopicsData, QSTableView;

__attribute__((visibility("hidden")))
@interface QSMyReplyTopicsViewController : QSViewController <QSTableViewDelegate, UITableViewDataSource, QSBaseDataDelegate>
{
    QSTableView *_tableView;
    QSMyReplyTopicsData *_replyTopicsData;
}

@property(retain, nonatomic) QSMyReplyTopicsData *replyTopicsData; // @synthesize replyTopicsData=_replyTopicsData;
