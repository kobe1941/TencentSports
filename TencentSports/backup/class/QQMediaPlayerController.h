...
@class AVPlayerItemVideoOutput, AVURLAsset, NSArray, NSDate, NSDictionary, NSHashTable, NSMutableURLRequest, NSString, NSTimer, NSURL, NSURLConnection, QLAVPlayer, QLAVPlayerItem, TVKResourceLoader, UIView;
...
@property(nonatomic) int liveProxyPlayId; // @synthesize liveProxyPlayId=_liveProxyPlayId;
