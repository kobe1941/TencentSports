...
@interface QSMatchDetailFootballFormationPlayer : QSModel
{
    _Bool _isStart;
    NSString *_playerId;
    NSString *_jerseyNum;
    NSString *_position;
    NSString *_squardPlace;
...
@property(retain, nonatomic) NSString *squardPlace; // @synthesize squardPlace=_squardPlace;
