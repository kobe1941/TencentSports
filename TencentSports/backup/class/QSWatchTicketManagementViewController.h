...
@class NSString, QSTableView, QSWatchTicketManageData;

__attribute__((visibility("hidden")))
@interface QSWatchTicketManagementViewController : QSViewController <QSTableViewDelegate, UITableViewDataSource, QSBaseDataDelegate>
{
    QSTableView *_tableView;
    QSWatchTicketManageData *_watchTicketManageData;
}

@property(retain, nonatomic) QSWatchTicketManageData *watchTicketManageData; // @synthesize watchTicketManageData=_watchTicketManageData;
