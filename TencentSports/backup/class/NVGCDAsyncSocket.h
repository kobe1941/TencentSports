...
@class NSData, NSMutableArray, NSString, NSURL, NVGCDAsyncReadPacket, NVGCDAsyncSocketPreBuffer, NVGCDAsyncWritePacket;
@protocol NVGCDAsyncSocketDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface NVGCDAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <NVGCDAsyncSocketDelegate> delegate;
    ...
    NVGCDAsyncReadPacket *currentRead;
    NVGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    NVGCDAsyncSocketPreBuffer *preBuffer;
...
@property __weak id <NVGCDAsyncSocketDelegate> delegate;
