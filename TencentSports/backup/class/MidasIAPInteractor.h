...
@class MidasIAPPayReq, MidasIAPPayResp, MidasOperationLoop, NSString;

@interface MidasIAPInteractor : NSObject <SKPaymentTransactionObserver, SKProductsRequestDelegate>
{
    _Bool _inited;
