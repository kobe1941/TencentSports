...
@protocol ODKDDLogger, OS_dispatch_queue;

@interface ODKDDLoggerNode : NSObject
{
    id <ODKDDLogger> _logger;
...
@property(readonly, nonatomic) id <ODKDDLogger> logger; // @synthesize logger=_logger;
- (void).cxx_destruct;
- (void)dealloc;
